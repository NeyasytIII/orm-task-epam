...
class TrainerServiceFileModeImplTest {
    ...
    void setUp() {
        ...
        trainerService = new TrainerServiceImpl("FILE", null, fileTrainerStorage, userNameGenerator);
    }
    ...
    void testCreateTrainer_Success() {
        ...
        when(userNameGenerator.generateUserName(eq("John"), eq("Doe"), anyMap(), anyMap()))
                .thenReturn("John.Doe");

        trainerService.createTrainer(id, "John", "Doe", "Yoga");
    ...
    void testCreateTrainer_InvalidInput() {
        assertThrows(IllegalArgumentException.class, () -> trainerService.createTrainer(null, "A", "B", "C"));
        assertThrows(IllegalArgumentException.class, () -> trainerService.createTrainer(1L, "", "B", "C"));
        assertThrows(IllegalArgumentException.class, () -> trainerService.createTrainer(1L, "A", null, "C"));
        assertThrows(IllegalArgumentException.class, () -> trainerService.createTrainer(1L, "A", "B", ""));
    }
    ...
    void testCreateTrainer_AlreadyExists() {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> trainerService.createTrainer(1L, "John", "Doe", "Yoga"));
    }
