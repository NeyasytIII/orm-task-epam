...
class TrainerServiceImplDatabaseTest {
    ...
    void testCreateTrainer_Success() {
        ...
        when(userNameGenerator.generateUserName(eq(firstName), eq(lastName), anyMap(), anyMap())).thenReturn("John.Doe");

        trainerService.createTrainer(id, firstName, lastName, specialization);
